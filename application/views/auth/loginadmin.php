        ...
        <div class="row justify-content-center">
            <div class="col-lg-7 mt-5">
                <div class="no-block bg-light align-items-center shadow-lg p-5 mb-5 bg-light rounded">
                    ...
                    <!-- Form -->
                    <form class="form-horizontal mt-3" id="loginform" action="<?= base_url('login/aksi_login'); ?>" method="POST">
                        <div class="row pb-4">
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-lg" name="username" id="username" required placeholder="Username" />
                                </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <div class="pt-3">
                                            <button class="btn btn-success float-end text-white mb-3" type="submit">
                                                Login
                                            </button>
                                        </div>
                                    </div>
